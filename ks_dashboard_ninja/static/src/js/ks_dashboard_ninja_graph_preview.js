    ...
    var KsGraphPreview = AbstractField.extend({
        ...
        renderChart: function(){
            ...
            if(this.chart_data && this.chart_data["datasets"].length>0){
               self.ksChartColors(this.recordData.ks_chart_item_color, this.ksMyChart, this.chart_type, this.chart_family,this.recordData.ks_bar_chart_stacked, this.recordData.ks_semi_circle_chart);
            }
        },
            ...
            if (ksChartFamily == "circle") {
                ...
                options.tooltips.callbacks = {
                                              title: function(tooltipItem, data) {
                                                          return data.datasets[tooltipItem[0].datasetIndex]['label']+" : "+ field_utils.format.float(data.datasets[tooltipItem[0].datasetIndex]['data'][tooltipItem[0].index], Float64Array);
                                                        },
