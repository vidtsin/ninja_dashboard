                ...
                for item in data['ks_item_data']:
                    ...
                    for ks_measure in item['ks_chart_measure_field']:
                        for x in self.env['ir.model'].search([('model', '=', item['ks_model_id'])]).modules.split(", "):
                            measure_id = x + '.field_' + ks_model + "_" + ks_measure
                    ...
                    for ks_list_field in item['ks_list_view_fields']:
                        for x in self.env['ir.model'].search([('model', '=', item['ks_model_id'])]).modules.split(", "):
                            list_field_id = x + '.field_' + ks_model + "_" + ks_list_field
                    ...
                    if item['ks_record_field']:
                        ...
                        for x in self.env['ir.model'].search([('model', '=', item['ks_model_id'])]).modules.split(", "):
                            record_id = x + '.field_' + ks_model + "_" + ks_record_field
                    ...
                    if item['ks_date_filter_field']:
                        ...
                        ks_record_id = self.env['ir.model.fields'].search([('name', '=', ks_date_filter_field), ('model', '=', item['ks_model_id'])])
                        if ks_record_id:
                    ...
                    if item['ks_chart_relation_sub_groupby']:
                        ...
                        for x in self.env['ir.model'].search([('model', '=', item['ks_model_id'])]).modules.split(", "):
                            field_id = x + '.field_' + ks_model + "_" + ks_group_by
